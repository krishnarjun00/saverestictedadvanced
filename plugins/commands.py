...
main_buttons = [[
        InlineKeyboardButton('Main Channel', url='https://t.me/hackermittron')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/xxyynnmm'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/hackermittron')
        ],[
